...
import { useSelectedNetwork } from "~~/hooks/globalEco";
import { useDeployedContractInfo } from "~~/hooks/globalEco";
import { AllowedChainIds } from "~~/utils/globalEco";
import { ContractAbi, ContractName, UseScaffoldEventConfig } from "~~/utils/globalEco/contract";
