...
type ChainAttributes = {
  ...
  // for networks having native currency other than GBD
...
export const getCustomRpcUrl = (chainId: number): string | undefined => {
  return scaffoldConfig.rpcOverrides?.[chainId] || process.env.NEXT_PUBLIC_RPC_URL;
};
...
export const NETWORKS_EXTRA_DATA: Record<string, ChainAttributes> = {
  [GLOBALCHAIN.id]: {
    color: "#ffffff", 
    //nativeCurrencyTokenAddress: "0xYourNativeTokenAddress", // optional
  },
  [chains.hardhat.id]: {
    color: "#b8af0c",
  },
